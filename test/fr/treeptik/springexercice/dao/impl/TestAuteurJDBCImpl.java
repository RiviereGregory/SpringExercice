...
import fr.treeptik.springexercice.dao.impl.AuteurJDBCImpl;
...
public class TestAuteurJDBCImpl {
	...
	public void testSaveOK() {
		try {
			Auteur auteur = auteurJDBCImpl.findAuteurs(1);
	...
	public void testFindNombreArticlesEnLigne() {
		try {
			Map<Auteur, Integer> map = auteurJDBCImpl.findNombreArticlesEnLigne();
