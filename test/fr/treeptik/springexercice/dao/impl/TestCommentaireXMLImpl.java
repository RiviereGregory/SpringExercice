...
public class TestCommentaireXMLImpl {
	...
	public void testSaveOK() {
		try {
			...
			Commentaire commentaire = new Commentaire(6, articleJDBCImpl.findArticles(2), "terre",
	...
	public void testFindAll() {
		...
		try {
			...
			for (Commentaire commentaire : list) {
				...
				System.out.println("art_id : " + commentaire.getArticles().getId());
				...
				System.out.println("date: " + dateFormat.format(commentaire.getDate()));
