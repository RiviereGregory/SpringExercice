...
public class TestCommentaireJDBCImpl {
	...
	public void testSaveOK() {
		try {
			Commentaire commentaire = commentaireJDBCImpl.findCommentaires(1);
	...
	public void testRemove() {
		try {
			Commentaire commentaire = commentaireJDBCImpl.findCommentaires(3);
	...
	public void testRemoveNotExist() {
		try {
			Commentaire commentaire = commentaireJDBCImpl.findCommentaires(2);
			commentaireJDBCImpl.remove(commentaire);
