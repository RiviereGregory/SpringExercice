...
import fr.treeptik.springexercice.dao.impl.ArticleJDBCImpl;
...
public class TestArticleJDBCImpl {
	...
	public void testSaveOK() {
		try {
			Article article = articleJDBCImpl.findArticles(1);
	...
	public void testFindArticlesNotExists() {
		try {
			articleJDBCImpl.findArticles(10000000);
	...
	public void testFindArticlesNull() {
		try {
			articleJDBCImpl.findArticles(null);
	...
	public void testFindArticlesEntreDate() {
		...
		try {
			...
			list = articleJDBCImpl.findArticles(dateDebut, dateFin);
			...
			for (Article article : list) {
				...
				System.out.println("En ligne : " + dateFormat.format(article.getDate()));
				System.out.println("");
			}
